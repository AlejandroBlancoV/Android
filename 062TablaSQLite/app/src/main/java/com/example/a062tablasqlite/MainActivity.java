package com.example.a062tablasqlite;
...
// Al hacer click corto sobre un elemento de la lista camiamos la funcionalidad del toast a colocar word y definition en los edittext
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //mEditTextWord=findViewById(R.id.listView);
